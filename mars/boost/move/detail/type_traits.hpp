...
#   define BOOST_MOVE_HAS_TRIVIAL_COPY(T)          (__is_trivially_copyable(T)|| ::mars_boost::move_detail::is_pod<T>::value)
#   define BOOST_MOVE_HAS_TRIVIAL_ASSIGN(T)        (__is_trivially_assignable(T&, const T&) || ::mars_boost::move_detail::is_pod<T>::value)
#   define BOOST_MOVE_HAS_TRIVIAL_DESTRUCTOR(T)    (__is_trivially_destructible(T) || ::mars_boost::move_detail::is_pod<T>::value)
#   define BOOST_MOVE_HAS_NOTHROW_CONSTRUCTOR(T)   (__is_nothrow_constructible(T) || ::mars_boost::move_detail::is_trivially_default_constructible<T>::value)
#   define BOOST_MOVE_HAS_NOTHROW_COPY(T)          (__is_nothrow_constructible(T) || ::mars_boost::move_detail::is_trivially_copy_constructible<T>::value)
#   define BOOST_MOVE_HAS_NOTHROW_ASSIGN(T)        (__is_nothrow_assignable(T) || ::mars_boost::move_detail::is_trivially_copy_assignable<T>::value)
...
#     define BOOST_MOVE_HAS_TRIVIAL_COPY(T) (__is_trivially_copyable(T) && ::mars_boost::move_detail::is_copy_constructible<T>::value)
#   endif
...
#     define BOOST_MOVE_HAS_NOTHROW_ASSIGN(T) (__is_nothrow_assignable(T))
#   endif
...
#   define BOOST_MOVE_HAS_TRIVIAL_ASSIGN(T) ((__is_trivially_assignable(T&, const T&) BOOST_MOVE_INTEL_TT_OPTS) )
#   define BOOST_MOVE_HAS_TRIVIAL_DESTRUCTOR(T) (__is_trivially_destructible(T) BOOST_MOVE_INTEL_TT_OPTS)
#   define BOOST_MOVE_HAS_NOTHROW_CONSTRUCTOR(T) (__is_nothrow_constructible(T) BOOST_MOVE_INTEL_TT_OPTS)
#   define BOOST_MOVE_HAS_NOTHROW_COPY(T) ((__is_nothrow_constructible(T) BOOST_MOVE_INTEL_TT_OPTS))
#   define BOOST_MOVE_HAS_NOTHROW_ASSIGN(T) ((__is_nothrow_assignable(T) BOOST_MOVE_INTEL_TT_OPTS))
