  ...
  namespace signals2
  {
    ...
    namespace detail
    {
      ...
      private:
        ...
        struct variant_to_shared_ptr_visitor : public boost::static_visitor<mars_boost::shared_ptr<void>>
        {
            mars_boost::shared_ptr<void> operator()(const mars_boost::shared_ptr<void>& ptr) const
            {
                return ptr;
            }

            mars_boost::shared_ptr<void> operator()(const detail::foreign_void_shared_ptr& /*ptr*/) const
            {
        ...
        T get_variant_value(const Variant& v)
        {
            return mars_boost::apply_visitor(variant_to_shared_ptr_visitor(), v);
        }
      ...
      public:
          ...
          OutputIterator inserter) const
        {
            ...
            ++it)
          {
            ...
            *inserter++ = get_variant_value<mars_boost::shared_ptr<void>>(locked_object);
          }
        }
