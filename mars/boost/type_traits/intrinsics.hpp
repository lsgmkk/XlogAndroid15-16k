...
#   define BOOST_HAS_TRIVIAL_ASSIGN(T) (__is_trivially_assignable(T) || ( ::mars_boost::is_pod<T>::value && ! ::mars_boost::is_const<T>::value && !::mars_boost::is_volatile<T>::value))
#   define BOOST_HAS_TRIVIAL_DESTRUCTOR(T) (__is_trivially_destructible(T) || ::mars_boost::is_pod<T>::value)
#   define BOOST_HAS_NOTHROW_CONSTRUCTOR(T) (__is_nothrow_constructible(T) || ::mars_boost::has_trivial_constructor<T>::value)
#if !defined(BOOST_INTEL)
#   define BOOST_HAS_NOTHROW_COPY(T) ((__is_nothrow_constructible(T) || ::mars_boost::has_trivial_copy<T>::value) && !is_array<T>::value)
#   define BOOST_HAS_TRIVIAL_COPY(T) (__is_trivially_copyable(T) || ::mars_boost::is_pod<T>::value)
#elif (_MSC_VER >= 1900)
...
#endif
#   define BOOST_HAS_NOTHROW_ASSIGN(T) (__is_nothrow_assignable(T) || ::mars_boost::has_trivial_assign<T>::value)
...
#   define BOOST_IS_POD(T) __is_pod(T)
#   define BOOST_IS_EMPTY(T) __is_empty(T)
#   define BOOST_HAS_TRIVIAL_CONSTRUCTOR(T) ((__is_trivially_constructible(T) BOOST_INTEL_TT_OPTS) && ! ::mars_boost::is_volatile<T>::value)
#   define BOOST_HAS_TRIVIAL_COPY(T) ((__is_trivially_copyable(T) BOOST_INTEL_TT_OPTS) && !is_reference<T>::value)
#if (__GNUC__ * 100 + __GNUC_MINOR__) >= 409
#   define BOOST_HAS_TRIVIAL_ASSIGN(T) ((__is_trivially_assignable(T) BOOST_INTEL_TT_OPTS) && ! ::mars_boost::is_volatile<T>::value && ! ::mars_boost::is_const<T>::value && is_assignable<T&, const T&>::value)
#   define BOOST_HAS_TRIVIAL_DESTRUCTOR(T) (__is_trivially_destructible(T) BOOST_INTEL_TT_OPTS && is_destructible<T>::value)
#   define BOOST_HAS_NOTHROW_CONSTRUCTOR(T) (__is_nothrow_constructible(T) && is_default_constructible<T>::value BOOST_INTEL_TT_OPTS)
...
#   define BOOST_HAS_NOTHROW_ASSIGN(T) ((__is_nothrow_assignable(T) BOOST_INTEL_TT_OPTS) && !is_volatile<T>::value && !is_const<T>::value && is_assignable<T&, const T&>::value)
#else
#   define BOOST_HAS_TRIVIAL_ASSIGN(T) ((__is_trivially_assignable(T) BOOST_INTEL_TT_OPTS) && ! ::mars_boost::is_volatile<T>::value && ! ::mars_boost::is_const<T>::value)
#   define BOOST_HAS_TRIVIAL_DESTRUCTOR(T) (__is_trivially_destructible(T) BOOST_INTEL_TT_OPTS)
#   define BOOST_HAS_NOTHROW_CONSTRUCTOR(T) (__is_nothrow_constructible(T) BOOST_INTEL_TT_OPTS)
...
#   define BOOST_HAS_NOTHROW_ASSIGN(T) ((__is_nothrow_assignable(T) BOOST_INTEL_TT_OPTS) && !is_volatile<T>::value && !is_const<T>::value && !is_array<T>::value)
#endif
#   define BOOST_HAS_VIRTUAL_DESTRUCTOR(T) __has_virtual_destructor(T)
...
#   define BOOST_HAS_TRIVIAL_CONSTRUCTOR(T) __is_trivially_constructible(T)
#   define BOOST_HAS_TRIVIAL_COPY(T) (__is_trivially_copyable(T) && !is_reference<T>::value)
#   define BOOST_HAS_TRIVIAL_ASSIGN(T) (__is_trivially_assignable(T) && !is_volatile<T>::value)
...
#   define BOOST_HAS_NOTHROW_ASSIGN(T) (__is_nothrow_assignable(T) && !is_volatile<T>::value)
#   define BOOST_HAS_VIRTUAL_DESTRUCTOR(T) __has_virtual_destructor(T)
