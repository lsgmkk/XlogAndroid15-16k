...
ANDROID_STL_FILE = {
    'armeabi-v7a': NDK_ROOT + '/toolchains/llvm/prebuilt/darwin-x86_64/sysroot/usr/lib/arm-linux-androideabi/libc++_shared.so',
    'arm64-v8a': NDK_ROOT + '/toolchains/llvm/prebuilt/darwin-x86_64/sysroot/usr/lib/aarch64-linux-android/libc++_shared.so',
    'x86': NDK_ROOT + '/toolchains/llvm/prebuilt/darwin-x86_64/sysroot/usr/lib/i686-linux-android/libc++_shared.so',
    'x86_64': NDK_ROOT + '/toolchains/llvm/prebuilt/darwin-x86_64/sysroot/usr/lib/x86_64-linux-android/libc++_shared.so',
}
